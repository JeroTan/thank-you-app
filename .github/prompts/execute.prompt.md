...
description: "Execute technical tasks within a feature workspace using a subagent-driven loop and user-defined pacing."
agent: "agent"
---
...
1. **Identify Target Feature**
   Scan tangram/features/ for active workspaces. If multiple exist and none were specified in the trigger, ask the user to select.
...
4. **Determine Execution Pace (The Interview)**
   **MANDATORY**: You MUST ask the user how they want to proceed with the execution:

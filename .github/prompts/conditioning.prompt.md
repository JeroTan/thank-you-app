...
description: "Run automated QA, including type checking, linters, and test suites to verify project stability."
agent: "agent"
---
...
2. **Setup Knowledge**: `.github/knowledge/setup/**` (Defines custom test scripts).
...
2. **The Conditioning Sequence**
   Execute the health checks in terminal:

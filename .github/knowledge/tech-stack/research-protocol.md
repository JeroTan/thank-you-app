...
- **Task Mastery:** You MUST break all research into granular sub-tasks using your internal task tracking BEFORE starting.
- **Zero Assumption:** You MUST use `#tool:vscode_askQuestions` at EVERY decision point. User preference > Evidence > AI Defaults.
...
You are FORBIDDEN from finalizing the stack without a `#tool:vscode_askQuestions` interview (5-8 questions) covering:

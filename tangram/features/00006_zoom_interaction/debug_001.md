...
s` to see how `.withGlobalScale()` is defined and used. Update it to properly handle the user zoom multiplier (`effectiveScale`) without breaking the canvas math.

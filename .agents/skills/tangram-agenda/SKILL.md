---
name: "tangram-agenda"
description: "Tangram command /tangram:agenda. Validate feature requirements and set the agenda before planning. Acts as a 'Unit Test for English'."
---

Codex adaptation of .codex/workflows/tangram/commands/tangram/construction/agenda.toml.

Use this skill when the user asks for /tangram:agenda, $tangram-agenda, or the corresponding Tangram workflow in natural language. Codex does not load source workflow .toml command files directly; this SKILL.md carries the converted prompt.

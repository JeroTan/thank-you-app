...
description: "Deep-dive into the system architecture, flow, and structural logic using modern patterns and internet research. Codex repo skill for the legacy /tangram:design-architecture workflow."
---

Codex adaptation: this skill was promoted from .codex/workflows/tangram/skills/design-architecture. Use it explicitly as $design-architecture, or ask for the matching Tangram workflow in natural language. Internal Tangram knowledge has been mirrored to .agents/knowledge.
...
Use `Codex web search` to research the best architectural patterns for the identified tech stack and project type. 

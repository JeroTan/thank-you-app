---
name: "explore-requirements"
description: "Define the functional and non-functional business requirements, mapping user needs to technical capabilities. Codex repo skill for the legacy /tangram:explore-requirements workflow."
---

Codex adaptation: this skill was promoted from .codex/workflows/tangram/skills/explore-requirements. Use it explicitly as $explore-requirements, or ask for the matching Tangram workflow in natural language. Internal Tangram knowledge has been mirrored to .agents/knowledge.

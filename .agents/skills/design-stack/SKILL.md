---
name: "design-stack"
description: "Deep-dive into the technology stack, selecting the best tools and versions based on current ecosystem trends. Codex repo skill for the legacy /tangram:design-stack workflow."
---

Codex adaptation: this skill was promoted from .codex/workflows/tangram/skills/design-stack. Use it explicitly as $design-stack, or ask for the matching Tangram workflow in natural language. Internal Tangram knowledge has been mirrored to .agents/knowledge.
...
Use `Codex web search` to find the latest stable versions and best practices for the suggested stack.

...
description: "Deep-dive into authentication, authorization, and data protection strategies. Codex repo skill for the legacy /tangram:design-security workflow."
---

Codex adaptation: this skill was promoted from .codex/workflows/tangram/skills/design-security. Use it explicitly as $design-security, or ask for the matching Tangram workflow in natural language. Internal Tangram knowledge has been mirrored to .agents/knowledge.
...
Use `Codex web search` to find the latest security recommendations for the chosen tech stack.

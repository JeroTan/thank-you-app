...
description: "Act as a Software System Analyst to proactively elicit, structure, and validate a comprehensive feature backlog using structured analysis modeling, including a sprint-ready implementation checklist. Codex repo skill for the legacy /tangram:explore-feature-backlog workflow."
---

Codex adaptation: this skill was promoted from .codex/workflows/tangram/skills/explore-feature-backlog. Use it explicitly as $explore-feature-backlog, or ask for the matching Tangram workflow in natural language. Internal Tangram knowledge has been mirrored to .agents/knowledge.

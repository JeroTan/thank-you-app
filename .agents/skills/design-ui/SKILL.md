---
name: "design-ui"
description: "Deep-dive into UI/UX design patterns across platforms (Web, Mobile, Desktop, CLI), incorporating user-provided brand guidelines and design preferences. Codex repo skill for the legacy /tangram:design-ui workflow."
---

Codex adaptation: this skill was promoted from .codex/workflows/tangram/skills/design-ui. Use it explicitly as $design-ui, or ask for the matching Tangram workflow in natural language. Internal Tangram knowledge has been mirrored to .agents/knowledge.
...
Use `Codex web search` to find best practices for the target platform and design inspirations.
